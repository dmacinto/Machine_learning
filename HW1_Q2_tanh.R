...
real <- transform(real, y_real = tanh(1.1 * x_real) + 2)
...
train <- transform(train, y_train = tanh(1.1 * x) + 2 + error)
...
test <- transform(test, y_test = tanh(1.1 * x) + 2 + error)
